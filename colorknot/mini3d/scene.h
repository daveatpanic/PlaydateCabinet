...
struct ShapeInstance
{
	...
	unsigned int inverted : 1; // transformation flipped it across a plane, so we need to reverse backface check
#if ENABLE_Z_BUFFER
	unsigned int useZBuffer : 1;
#endif
#if ENABLE_ORDERING_TABLE
	int orderTableSize;
